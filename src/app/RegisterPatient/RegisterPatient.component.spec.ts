...
describe('RegisterPatientComponent', () => {
  ...
  let mockRegisterPatientService;
  let mockDataService

  beforeEach(async(() => {

    mockRegisterPatientService = sinon.createStubInstance(RegisterPatientService);
    mockRegisterPatientService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: RegisterPatientService, useValue: mockRegisterPatientService },
