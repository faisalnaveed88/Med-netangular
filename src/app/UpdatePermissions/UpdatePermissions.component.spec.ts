...
import { UpdatePermissionsComponent } from './UpdatePermissions.component';
...
describe('UpdatePermissionsComponent', () => {
  ...
  let mockUpdatePermissionsService;
  let mockDataService

  beforeEach(async(() => {

    mockUpdatePermissionsService = sinon.createStubInstance(UpdatePermissionsService);
    mockUpdatePermissionsService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: UpdatePermissionsService, useValue: mockUpdatePermissionsService },
